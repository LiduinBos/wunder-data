...
fig = df_all.plot(x='TIMESTAMP',y=["Incoming short wave radiation","Outcoming short wave radiation","Corrected incoming long wave radiation","Corrected outcoming long wave radiation"]) #,'Rn'])
