...
fig.update_layout(hovermode="x unified",xaxis_title=None,yaxis_title='Radiation [W/m2]', labels={"SWTop":"Incoming short wave radiation","SWBottom":"Outcoming short wave radiation","LWTop_cor":"Corrected incoming long wave radiation","LWBottom_cor":"Corrected outcoming long wave radiation"})
