...
#     data = {**default_args, **extra_kwargs_for_endpoint, "device_sn": sn}
#     all_readings = {var: [] for var in variables}  # Store data for each variable
...
# # List of variables to retrieve (e.g., 'Air Temperature', 'Precipitation', 'Humidity')
# variables = ['Air Temperature', 'Precipitation', 'Humidity']
