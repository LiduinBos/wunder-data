...
api_url = st.text_input('API Endpoint URL', 'https://zentracloud.com/api/'+stnr)
...
if st.button('Make API Call'):
    try:
        ...
        headers = {
            'Authorization': 'Token f9e6d698624c76340adde78b22a9c6ff514c6e42',
...
# tok = "Token f9e6d698624c76340adde78b22a9c6ff514c6e42"
# sn="z6-#####"
